...
export default function ContainerThird(){
    ...
    return(<div className="containerThird">
        ...
        <div style={{display: 'flex'}}><div><p>O workshop Fora da Caixa, em sua segunda edição, é seu aprendizado seguro de técnicas estratégicas e em alta no mercado da papelaria personalizada, onde, sem ele, somente as mais experientes do mercado conseguiriam aplicar.</p>
