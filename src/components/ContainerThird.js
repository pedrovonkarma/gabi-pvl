...
export default function ContainerThird(){
    ...
    return(<div className="containerThird">
        ...
        <div className='secondCont'><div><p>O workshop Fora da Caixa, em sua segunda edição, é seu aprendizado seguro de técnicas estratégicas e em alta no mercado da papelaria personalizada, onde, sem ele, somente as mais experientes do mercado conseguiriam aplicar.</p>
        ...
        </div><img  className='foto2' src={foto2} alt='foto'/></div><button onClick={() => window.open("#")}>QUERO ASSISTIR ÀS AULAS AGORA</button>
